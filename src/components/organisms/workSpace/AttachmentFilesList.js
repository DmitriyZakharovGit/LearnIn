...
import GetAppIcon from '@material-ui/core/SvgIcon/SvgIcon';
...
export default function () {
	...
	return (
		<div className={classes.root}>
			...
			<GridList cellHeight={180} spacing={2} className={classes.gridList}>
				<GridListTile key="image" cols={1} rows={1}>
					...
					<GridListTileBar
						...
						titlePosition="top"
						actionIcon={(
							<IconButton aria-label="star image" className={classes.icon}>
								<GetAppIcon />
							</IconButton>
						)}
						actionPosition="left"
